...
async function connectToWA() {
  ...
  console.log("Connecting DANTE XMD");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("DANTE XMD HAS SUCCESFULLY BEEN CONNECTED TO YOUR WHATSAPP ✅");
  ...
  ╚═════════════════╝`;
      ...
      robin.sendMessage("263788533181@s.whatsapp.net", {
        image: {
          url: `https://i.ibb.co/6Rxhg321/Chat-GPT-Image-Mar-30-2025-03-39-42-AM.png`,
        },
        caption: up1,
...
//=====================================================================================================================================
  ...
  app.get("/", (req, res) => {
    res.send("DANTE XMD LAUNCHED AND READY TO USE ✅");
  });
